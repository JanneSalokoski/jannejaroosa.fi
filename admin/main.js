...
var $author$project$Main$GuestsMsg = function (a) {
	return {$: 'GuestsMsg', a: a};
};
var $author$project$Main$LoginMsg = function (a) {
	return {$: 'LoginMsg', a: a};
};
var $author$project$Main$Model = F4(
	function (responsesModel, progressModel, guestsModel, loginModel) {
		return {guestsModel: guestsModel, loginModel: loginModel, progressModel: progressModel, responsesModel: responsesModel};
	});
...
var $author$project$Features$Guests$FetchGuest = function (a) {
	return {$: 'FetchGuest', a: a};
};
var $author$project$Features$Guests$Model = F3(
	function (progress, loading, error) {
		return {error: error, loading: loading, progress: progress};
	});
var $author$project$Features$Guests$init = function (_v0) {
	return _Utils_Tuple2(
		A3($author$project$Features$Guests$Model, _List_Nil, false, $elm$core$Maybe$Nothing),
		A2(
			$elm$core$Task$perform,
			function (_v1) {
				return $author$project$Features$Guests$FetchGuest($elm$core$Maybe$Nothing);
			},
			$elm$core$Task$succeed(_Utils_Tuple0)));
};
var $author$project$Features$Login$Model = F4(
	function (user, token, loading, error) {
		return {error: error, loading: loading, token: token, user: user};
	});
var $author$project$Shared$Types$User = F2(
	function (username, password) {
		return {password: password, username: username};
	});
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Features$Login$init = function (_v0) {
	return _Utils_Tuple2(
		A4(
			$author$project$Features$Login$Model,
			A2($author$project$Shared$Types$User, '', ''),
			$elm$core$Maybe$Nothing,
			false,
			$elm$core$Maybe$Nothing),
		$elm$core$Platform$Cmd$none);
};
var $author$project$Features$Progress$FetchProgress = function (a) {
	return {$: 'FetchProgress', a: a};
};
...
var $author$project$Features$Progress$init = function (_v0) {
	return _Utils_Tuple2(
		...
		A2(
			$elm$core$Task$perform,
			function (_v1) {
				return $author$project$Features$Progress$FetchProgress($elm$core$Maybe$Nothing);
			},
			$elm$core$Task$succeed(_Utils_Tuple0)));
};
var $author$project$Features$Responses$FetchResponses = function (a) {
	return {$: 'FetchResponses', a: a};
};
...
var $author$project$Features$Responses$init = function (_v0) {
	return _Utils_Tuple2(
		...
		A2(
			$elm$core$Task$perform,
			function (_v1) {
				return $author$project$Features$Responses$FetchResponses($elm$core$Maybe$Nothing);
			},
			$elm$core$Task$succeed(_Utils_Tuple0)));
};
...
var $author$project$Main$init = function (_v0) {
	...
	var _v3 = $author$project$Features$Login$init(_Utils_Tuple0);
	var loginModel = _v3.a;
	var loginCmd = _v3.b;
	var _v4 = $author$project$Features$Guests$init(_Utils_Tuple0);
	var guestsModel = _v4.a;
	var guestsCmd = _v4.b;
	return _Utils_Tuple2(
		A4($author$project$Main$Model, responsesModel, progressModel, guestsModel, loginModel),
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					...
					A2($elm$core$Platform$Cmd$map, $author$project$Main$GuestsMsg, guestsCmd),
...
var $author$project$Features$Guests$FetchGuestError = function (a) {
	return {$: 'FetchGuestError', a: a};
};
...
var $author$project$Shared$Types$Guest = F6(
	function (id, name, group, diet, rsvp, time) {
		return {diet: diet, group: group, id: id, name: name, rsvp: rsvp, time: time};
	});
...
var $author$project$Api$Guests$guestDecoder = A4(
			...
			A3(
				...
				A3(
					...
					A3(
						...
						$elm$json$Json$Decode$succeed($author$project$Shared$Types$Guest)))))));
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Api$Guests$guestsDecoder = $elm$json$Json$Decode$list($author$project$Api$Guests$guestDecoder);
...
var $author$project$Api$Guests$fetchGuest = F2(
	function (token, handler) {
		var url = A2(
			$elm$core$Debug$log,
			'guests url',
			$author$project$Api$Api$buildEndpointUrl('guests'));
		...
		return $elm$http$Http$request(
			{
				...
				expect: A2($elm$http$Http$expectJson, handler, $author$project$Api$Guests$guestsDecoder),
				headers: headers,
				method: 'GET',
...
var $author$project$Features$Guests$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'FetchGuest':
				var token = msg.a;
				return _Utils_Tuple2(
					...
					A2(
						$author$project$Api$Guests$fetchGuest,
						token,
						function (result) {
							if (result.$ === 'Ok') {
								var progress = result.a;
								return $author$project$Features$Guests$FetchGuestSuccess(progress);
							} else {
								var error = result.a;
								return $author$project$Features$Guests$FetchGuestError(
									$author$project$Shared$Error$toString(error));
							}
						}));
			case 'FetchGuestSuccess':
				var progress = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var $author$project$Features$Login$FetchTokenError = function (a) {
	return {$: 'FetchTokenError', a: a};
};
var $author$project$Features$Login$FetchTokenSuccess = function (a) {
	return {$: 'FetchTokenSuccess', a: a};
};
...
var $author$project$Api$Login$encodeUser = function (user) {
...
var $author$project$Shared$Types$Token = F2(
	function (access_token, token_type) {
		return {access_token: access_token, token_type: token_type};
	});
var $author$project$Api$Login$tokenDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'token_type',
	$elm$json$Json$Decode$string,
	A3(
		...
		'access_token',
		$elm$json$Json$Decode$string,
		$elm$json$Json$Decode$succeed($author$project$Shared$Types$Token)));
var $author$project$Api$Login$fetchToken = F2(
	function (user, handler) {
		return $elm$http$Http$post(
			{
				body: $elm$http$Http$jsonBody(
					$author$project$Api$Login$encodeUser(user)),
				expect: A2($elm$http$Http$expectJson, handler, $author$project$Api$Login$tokenDecoder),
				url: $author$project$Api$Api$buildEndpointUrl('auth/login')
			});
	});
var $author$project$Features$Login$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'FetchToken':
				return _Utils_Tuple2(
					_Utils_update(
						...
						{error: $elm$core$Maybe$Nothing, loading: true}),
					A2(
						$author$project$Api$Login$fetchToken,
						model.user,
						function (result) {
							if (result.$ === 'Ok') {
								var token = result.a;
								return $author$project$Features$Login$FetchTokenSuccess(token);
							} else {
								var error = result.a;
								return $author$project$Features$Login$FetchTokenError(
									$author$project$Shared$Error$toString(error));
							}
						}));
...
var $author$project$Api$Progress$fetchProgress = F2(
	function (token, handler) {
		var url = A2(
			$elm$core$Debug$log,
			'url',
			$author$project$Api$Api$buildEndpointUrl('progress/stats'));
		var accessToken = function () {
			if (token.$ === 'Just') {
				var x = token.a;
				return x.access_token;
...
var $author$project$Api$Responses$fetchResponses = F2(
	function (token, handler) {
		var url = A2(
			$elm$core$Debug$log,
			'url',
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'GuestsMsg':
				var guestsMsg = msg.a;
				var _v3 = A2($author$project$Features$Guests$update, guestsMsg, model.guestsModel);
				var newGuestsModel = _v3.a;
				var guestsCmd = _v3.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{guestsModel: newGuestsModel}),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$GuestsMsg, guestsCmd));
			default:
				var loginMsg = msg.a;
				var _v4 = A2($author$project$Features$Login$update, loginMsg, model.loginModel);
				var newLoginModel = _v4.a;
				var loginCmd = _v4.b;
				var isLoggedIn = function () {
					var _v8 = newLoginModel.token;
					if (_v8.$ === 'Just') {
						return true;
					} else {
						return false;
				...
				var reloadCmds = isLoggedIn ? $elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[
							A2(
							...
							A2(
								$elm$core$Task$perform,
								function (_v5) {
									return $author$project$Features$Responses$FetchResponses(newLoginModel.token);
								},
								$elm$core$Task$succeed(_Utils_Tuple0))),
							A2(
							$elm$core$Platform$Cmd$map,
							...
							A2(
								$elm$core$Task$perform,
								function (_v6) {
									return $author$project$Features$Progress$FetchProgress(newLoginModel.token);
								},
								$elm$core$Task$succeed(_Utils_Tuple0))),
							A2(
							$elm$core$Platform$Cmd$map,
							$author$project$Main$GuestsMsg,
							A2(
								$elm$core$Task$perform,
								function (_v7) {
									return $author$project$Features$Guests$FetchGuest(newLoginModel.token);
								},
								$elm$core$Task$succeed(_Utils_Tuple0)))
						])) : $elm$core$Platform$Cmd$none;
				return _Utils_Tuple2(
...
var $author$project$Features$Guests$formatTime = function (time) {
	var date = A2(
		$elm$core$Debug$log,
		'date',
	...
	return A3(
		...
		$elm$core$String$fromInt(
			$justinmimbs$date$Date$day(date))) + ('.' + (A3(
		$elm$core$String$pad,
		2,
		_Utils_chr('0'),
		$elm$core$String$fromInt(
		...
		_Utils_chr('0'),
		$elm$core$String$fromInt(
			A2($elm$time$Time$toHour, $elm$time$Time$utc, time))) + (':' + A3(
		$elm$core$String$pad,
		2,
		_Utils_chr('0'),
		$elm$core$String$fromInt(
...
var $author$project$Features$Guests$viewGuest = function (guest) {
	return A2(
		$elm$html$Html$ul,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('Guest')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('guest_id')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromInt(guest.id))
					])),
				A2(
				$elm$html$Html$li,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(guest.group)
					])),
				A2(
				$elm$html$Html$li,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('diet')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(guest.diet)
					])),
				A2(
				$elm$html$Html$li,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('rsvp')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Features$Guests$formatTime(guest.time))
					]))
			]));
};
var $author$project$Features$Guests$viewGuestHeaders = A2(
	$elm$html$Html$ul,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('Guest'),
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Ilmoittatumisaika')
				]))
		]));
var $author$project$Features$Guests$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$cons,
					$author$project$Features$Guests$viewGuestHeaders,
					A2($elm$core$List$map, $author$project$Features$Guests$viewGuest, model.progress))),
				function () {
				var _v0 = model.error;
				if (_v0.$ === 'Just') {
					var err = _v0.a;
...
var $author$project$Features$Login$FetchToken = {$: 'FetchToken'};
var $author$project$Features$Login$PasswordChanged = function (a) {
	return {$: 'PasswordChanged', a: a};
};
var $author$project$Features$Login$UsernameChanged = function (a) {
...
var $author$project$Features$Login$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('login'),
						$elm$html$Html$Events$onSubmit($author$project$Features$Login$FetchToken)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('inputBlock')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$placeholder('Keijo Käyttäjä'),
										$elm$html$Html$Attributes$value(model.user.username),
										$elm$html$Html$Events$onInput($author$project$Features$Login$UsernameChanged)
									]),
								_List_Nil)
							])),
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$placeholder('Villisilmä'),
										$elm$html$Html$Attributes$value(model.user.password),
										$elm$html$Html$Events$onInput($author$project$Features$Login$PasswordChanged)
									]),
								_List_Nil)
							])),
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$id('submit'),
										$elm$html$Html$Attributes$value('Kirjaudu sisään')
									]),
								_List_Nil)
							]))
					])),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromInt(response.id))
					])),
				A2(
				$elm$html$Html$li,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(response.name)
					])),
				A2(
				$elm$html$Html$li,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(response.diet)
					])),
				A2(
				$elm$html$Html$li,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						response.rsvp ? 'Osallistuu' : 'Ei osallistu')
					])),
				A2(
				$elm$html$Html$li,
				_List_fromArray(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Features$Login$view(model.loginModel)),
				A2(
				$elm$html$Html$map,
				$author$project$Main$GuestsMsg,
				$author$project$Features$Guests$view(model.guestsModel)),
				A2(
				$elm$html$Html$map,
				$author$project$Main$ProgressMsg,
